  ...
  return (
    <div id="weather-intelligence-root" className="min-h-screen bg-slate-900 text-slate-100 font-sans antialiased selection:bg-teal-500/30 selection:text-teal-200">
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-8 flex flex-col gap-8">
        ...
        {/* DEVELOPER RESOURCES & DEPLOYMENT MANUAL */}
        <section id="developer-docs" className="mt-8 rounded-3xl border border-slate-800 bg-slate-950/75 p-6 sm:p-8">
          ...
          <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
            ...
            <div>
              <h3 className="text-base font-display font-bold text-slate-100">
                Deployment Manual & Cloudflare Integration
              </h3>
              <p className="text-xs text-slate-400">
                Self-contained deployment script documentation for engineering handoff
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-slate-300">
            ...
            <div className="p-5 rounded-2xl bg-slate-900/40 border border-slate-800/80 flex flex-col gap-3">
              <h4 className="font-bold text-slate-100 text-sm flex items-center gap-1.5 text-teal-400">
                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-teal-950 text-teal-400 text-[10px] font-mono border border-teal-500/30">1</span>
                GitHub Sync Sequence
              </h4>
              <p className="text-slate-400 leading-relaxed">
                Connect your workspace directly to continuous integration networks:
              </p>
              <ol className="list-decimal list-inside space-y-2 pl-1.5 text-slate-300 leading-relaxed">
                <li>Create an empty repository on your personal <span className="font-semibold text-slate-100">GitHub Dashboard</span>.</li>
                <li>In Google AI Studio, access the top-right <span className="font-semibold text-slate-100">Settings</span> panel.</li>
                <li>Initiate the <span className="font-semibold text-teal-400">Export to GitHub</span> action.</li>
                <li>Grant authorized access to your account and select the target repository.</li>
                <li>Push the source branch (typically <code className="font-mono bg-slate-800 px-1 py-0.5 rounded text-slate-300">main</code>) to complete synchronization.</li>
              </ol>
            </div>

            <div className="p-5 rounded-2xl bg-slate-900/40 border border-slate-800/80 flex flex-col gap-3">
              <h4 className="font-bold text-slate-100 text-sm flex items-center gap-1.5 text-teal-400">
                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-teal-950 text-teal-400 text-[10px] font-mono border border-teal-500/30">2</span>
                Cloudflare Pages Setup
              </h4>
              <p className="text-slate-400 leading-relaxed">
                Deploy static single-page assets globally to Edge network environments:
              </p>
              <ul className="space-y-2 pl-1.5 text-slate-300 leading-relaxed">
                <li>
                  <strong className="text-slate-100 block">Framework Preset:</strong>
                  Choose <span className="text-emerald-400">Vite</span> inside the build settings wizard.
                </li>
                <li>
                  <strong className="text-slate-100 block">Build Command:</strong>
                  Use the standardized node script <code className="font-mono bg-slate-800 px-1.5 py-0.5 rounded text-slate-300">npm run build</code>.
                </li>
                <li>
                  <strong className="text-slate-100 block">Output Directory:</strong>
                  Set destination pointer target to <code className="font-mono bg-slate-800 px-1.5 py-0.5 rounded text-teal-400">dist</code>.
                </li>
                <li>
                  <strong className="text-slate-100 block">Node Compatibility:</strong>
                  Ensure the environment has environment version variable <code className="font-mono bg-slate-800 px-1 py-0.5 rounded text-slate-300">NODE_VERSION = 18</code> or higher.
                </li>
              </ul>
            </div>
          ...
          {/* Quick Config JSON Block */}
          <div className="mt-6">
            <div className="flex items-center justify-between px-4 py-2.5 bg-slate-900 border border-slate-800 rounded-t-xl text-xs font-mono text-slate-400">
              <span>cloudflare-pages-preset.json</span>
              <span className="text-[10px] text-teal-500 bg-teal-950/50 px-2 py-0.5 rounded font-bold uppercase tracking-wider">Production Stable</span>
            </div>
            <pre className="p-4 bg-slate-950/80 border-x border-b border-slate-800 rounded-b-xl text-xs font-mono text-emerald-400 overflow-x-auto">
{`{
  "project_name": "weather-intelligence-platform",
